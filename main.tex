...
\begin{abstract}
    These notes are the content of my seminar for the final exam of the course \emph{Mathematical Physics – Differential Geometric Methods}, taught by Enrico Pagani during the Spring semester of 2025.
\end{abstract}
\tableofcontents
...
\section{Hodge theory with for compact manifolds with boundary}
\input{Boundary}
