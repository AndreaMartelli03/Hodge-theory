...
\date{Trento, September 2025}
\begin{document}

\maketitle

\begin{abstract}
    These notes are the content of my seminar for the final exam of the course \emph{Mathematical Physics – Differential Geometric Methods}, taught by Prof. Enrico Pagani during the Spring semester of 2025 at University of Trento.
\end{abstract}
\tableofcontents
...
\section{Hodge theory for compact manifolds with boundary}
\input{Boundary}
